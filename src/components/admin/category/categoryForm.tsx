...
function CategoryForm() {
    ...
    useEffect(() => {
        ...
        if (categoriaSeleccionado) {
            ...
            if (typeof articulo.imagen === "string" && articulo.imagen.trim() !== "") {
                setImagen(articulo.imagen);
                setPreviewUrl(articulo.imagen);
            }
    ...
    return (
        <div className="mb-10 mt-32 max-w-6xl mx-auto bg-white shadow-md rounded-lg overflow-hidden relative p-6">
            <div className="absolute top-6 right-6">
                <a className="text-white bg-[#6E9475] hover:bg-[#5C8465] focus:ring-4 focus:outline-none focus:ring-[#D4C9B0] font-medium rounded-lg text-sm px-5 py-2.5" href="/categorias" data-translate>
                    Regresar
                </a>
            </div>
