function SubCategoryHeader() {
    ...
    return (
        <div
            className="text-[#2F4F4F] text-2xl mb-4 p-4 rounded-lg shadow-lg bg-[#FAF3E0] flex items-center justify-between"
            onClick={handleClick}
        >
            <p className="text-center" data-translate>Sub-Categorías</p>
            <a
