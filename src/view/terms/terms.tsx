    ...
    <div>
      ...
      <div className="bg-[#FAF3E0] min-h-screen py-10 px-6 md:px-16">
        <div className="mt-20 max-w-screen-lg mx-auto">
          ...
          <p className="text-center text-[#2F4F4F] mb-8" data-translate>
          ...
          <div className="bg-white border border-[#D4C9B0] rounded-lg shadow-md p-6 space-y-6">
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>1. Introducción</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>2. Uso del sitio</h2>
              <p className="text-[#2F4F4F]" data-translate>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>3. Registro y cuentas</h2>
              <p className="text-[#2F4F4F]" data-translate>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>4. Compras y pagos</h2>
              <p className="text-[#2F4F4F]" data-translate>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>5. Política de devoluciones</h2>
              <p className="text-[#2F4F4F]" data-translate>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>6. Protección de datos</h2>
              <p className="text-[#2F4F4F]" data-translate>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>7. Modificaciones de los términos</h2>
              <p className="text-[#2F4F4F]" data-translate>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#6E9475] mb-2" data-translate>8. Contacto</h2>
              <p className="text-[#2F4F4F]" data-translate>
